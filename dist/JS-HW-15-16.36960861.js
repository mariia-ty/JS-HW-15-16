...
box.addEventListener("input", (0, _lodashDebounceDefault.default)(onInput, 500));
...
function onInput(entry) {
    ...
    fetchCountries(query).then((countries)=>{
        ...
        else if (countries.length === 1) countryInfo(countries[0]);
        else (0, _core.error)({
            text: "No country found with that name."
        });
    }).catch(()=>{
        (0, _core.error)({
            text: "Oops! Something went wrong with the request."
        });
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","lodash.debounce":"irvaP","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["io2N8","bNJxx"], "bNJxx", "parcelRequirea26c", {})

//# sourceMappingURL=JS-HW-15-16.36960861.js.map
